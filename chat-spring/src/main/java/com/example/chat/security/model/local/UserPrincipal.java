package com.example.chat.security.model.local;
...
public class UserPrincipal implements OAuth2User, UserDetails {
    ...
    public static UserPrincipal create(final User user) {
        final List<GrantedAuthority> authorities = Collections.singletonList(new SimpleGrantedAuthority("ROLE_" + user.getRole().name()));
